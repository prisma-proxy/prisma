...
| `AcceptStatus::VersionMismatch` | 客户端和服务端协议版本不同 | 确保两端都是 v2.21.0（仅 PrismaVeil v5） |
...
4. 在 [GitHub](https://github.com/Yamimega/prisma/issues) 上提交问题，附上日志和诊断输出
