...
This guide walks you through setting up Prisma v2.24.0 and running your first proxy session — from pre-built binaries or from source.
...
Download the latest v2.24.0 release for your platform:
