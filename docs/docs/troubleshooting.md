...
Common issues and their solutions for Prisma v2.6.0.
...
| `AcceptStatus::VersionMismatch` | Client and server protocol versions differ | Ensure both are v2.6.0 (PrismaVeil v5 only) |
