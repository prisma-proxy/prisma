...
Common issues and their solutions for Prisma v2.13.0.
...
| `AcceptStatus::VersionMismatch` | Client and server protocol versions differ | Ensure both are v2.13.0 (PrismaVeil v5 only) |
...
4. Open an issue on [GitHub](https://github.com/Yamimega/prisma/issues) with the logs and diagnostic output
