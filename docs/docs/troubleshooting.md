...
Common issues and their solutions for Prisma v2.1.4.
...
| `AcceptStatus::VersionMismatch` | Client and server protocol versions differ | Ensure both are v2.1.4 (PrismaVeil v5 only) |
