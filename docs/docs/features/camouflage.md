...
In addition to decoy fallback, Prisma v2.8.0 includes a **TLS probe guard** that automatically detects and blocks IPs exhibiting repeated TLS handshake failures. This is a strong indicator of active probing -- censorship systems often attempt rapid connection sequences to fingerprint the server.
