      ...
      messages: [
        {
          ...
          content: {
            ...
            text:
              ...
              `   - [ ] UI change? -- update prisma-gui/prisma-console\n` +
  ...
  server.prompt(
    ...
    "Security audit checklist for a specific file, crate, or subsystem in the Prisma workspace",
    {
      target: z.string().describe(
        "File path or crate name to audit (e.g., 'prisma-core' or 'prisma-core/src/crypto/aead.rs')",
      ),
    },
    async ({ target }) => ({
      messages: [
      ...
      messages: [
        {
          ...
          content: {
            ...
            text:
              ...
              `- [ ] Crypto subsystem audit (prisma-core/src/crypto/)\n` +
              `- [ ] Protocol handshake audit (prisma-core/src/protocol/)\n` +
              `- [ ] FFI boundary audit (prisma-ffi/src/)\n` +
