...
:::info Version
This page reflects Prisma **v1.3.0**. Protocol v4 support has been removed; only PrismaVeil v5 (0x05) is accepted.
:::
...
| `protocol_version` | string | `"v5"` | Protocol version (read-only, always `"v5"` in 1.3.0) |
