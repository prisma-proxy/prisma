...
Common issues and their solutions for Prisma v1.3.0.
...
| `AcceptStatus::VersionMismatch` | Client and server protocol versions differ | Ensure both are v1.3.0 (PrismaVeil v5 only) |
