...
Common issues and their solutions for Prisma v0.9.0.
...
| `AcceptStatus::VersionMismatch` | Client and server protocol versions differ | Ensure both are v0.9.0 (PrismaVeil v5 only) |
