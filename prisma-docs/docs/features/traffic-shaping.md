...
PrismaVeil v4 includes traffic shaping defenses against encapsulated TLS fingerprinting, as described in USENIX Security 2024 research. These defenses prevent censors from identifying proxy traffic by analyzing packet size distributions and timing patterns.
