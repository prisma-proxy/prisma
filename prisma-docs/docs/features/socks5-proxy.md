...
Prisma implements a full RFC 1928 SOCKS5 proxy interface on the client side (v1.4.0). Applications connect to the local SOCKS5 port, and traffic is transparently tunneled through the encrypted PrismaVeil connection to the server.
