...
As of v1.3.0, Prisma supports **9 distinct transport families** (12 configurations including variants). Different transports have different detectability profiles:
